...
class ReceptionistAppTests(TestCase):
    def setUp(self):
        ...
        self.appointment = Appointment.objects.create(
            ...
            date_time="2023-12-02T11:00:00Z",
            status="Scheduled"
        )
    ...
    def test_billing_amount(self):
        # consultation_fee derived from doctor (300) + medicine_fee (300) => total 600
        self.assertEqual(float(self.billing.consultation_fee), 300.00)
        self.assertEqual(float(self.billing.total_fee), 600.00)
